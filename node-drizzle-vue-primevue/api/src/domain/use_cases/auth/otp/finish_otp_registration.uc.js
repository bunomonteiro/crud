 ...
 */
function FinishOtpRegistrationUseCase(libs, repository) {
  /**
...
const FinishOtpRegistrationUseCaseName = 'uc.finish.otp.registration'

module.exports = {
  FinishOtpRegistrationUseCase,
  FinishOtpRegistrationRequest,
  FinishOtpRegistrationResponse,
  FinishOtpRegistrationUseCaseName
};
