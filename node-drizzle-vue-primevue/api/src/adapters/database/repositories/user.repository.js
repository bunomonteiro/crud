...
const { filtersToWhere, sortingToOrderBy } = require('./../drizzle.helper')
...
const { PaginatedQueryModel, UserModel, UserHistoryModel } = require("../../../domain/entities/user.aggregate")
...
function UserRepository(connector) {
  let _db = drizzle(connector, { 
    logger: global.configurations.server.isDevelopment, 
    schema: { 
      users: UserSchema,
