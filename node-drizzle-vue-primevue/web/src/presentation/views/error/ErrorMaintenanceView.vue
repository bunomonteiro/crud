<template>
  <div class="flex flex-column justify-content-center align-items-center h-screen w-screen">
    <div class="content text-center">
      ...
      <h1 class="text-8xl mb-0">Em Manutenção</h1>
      <h2 class="text-2xl mt-0 mb-6 text-color-secondary">Lamentamos o inconveniente. Enquanto isso, entre em contato conosco para qualquer dúvida</h2>
    </div>
  </div>
</template>
